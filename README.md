...
ReCluster는 집에 방치된 낡은 하드웨어를 재활용하여 강력한 홈서버 클러스터를 구축할 수 있는 Ansible 기반 자동화 솔루션입니다. 복잡한 클러스터 설정 과정을 간단한 대화형 인터페이스로 제공하여, 누구나 쉽게 자신만의 분산 컴퓨팅 환경을 만들 수 있습니다.
...
- **제어 노드** (설정을 실행할 컴퓨터):
  - Alpine Linux, Ubuntu, Debian 등 Linux 배포판
  - 루트 권한
  - 인터넷 연결
...
ReCluster는 오픈소스 프로젝트입니다. 기여를 환영합니다!
